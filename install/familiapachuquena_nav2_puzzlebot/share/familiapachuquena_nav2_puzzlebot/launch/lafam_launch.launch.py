...
def launch_setup(context, *args, **kwargs):
    ...
    if mode == 'nav':
        ...
        raise RuntimeError(f"[gazebo_world.launch.py] Modo desconocido '{mode}', se esperaba 'nav'.")

    return actions

def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('mode', default_value='nav', description='Solo modo nav'),
